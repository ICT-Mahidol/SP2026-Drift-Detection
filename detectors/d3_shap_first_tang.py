...
class DiscriminativeDriftDetector2019SHAPFirst_permutation(DiscriminativeDriftDetector2019SHAP):
    """
    ...
    def _compute_shap_values(self) -> np.ndarray:
        """
        Returns the SHAP values for the first class across all samples in the data
